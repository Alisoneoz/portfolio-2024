  ...
  return (
    <div className="overflow-x-hidden ">
      ...
      <main className="flex flex-col items-center sm:items-start w-full my-auto">
        {/* Hero Section */}
        <section id="home" className="relative w-screen h-screen justify-center flex flex-col">
          <ParticlesBackground
          ...
          <AnimatedTitle>
            ...
            <p className="text-center pt-6 text-lg">Building Modern Digital Experiences</p>
          </AnimatedTitle>
        </section>
        ...
        <AnimatedSection
          ...
          className="bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-violet-600 via-black to-black flex flex-col w-full "
        >
        ...
        {/* Project Section */}
        <AnimatedSection className="bg-[radial-gradient(ellipse_at_left,_var(--tw-gradient-stops))] from-violet-800 via-black to-black">
